...
After that, we need also the box plots of the search volume data. In the box plots below, we can see there is an increase in the search volume which can be interpreted as increased demand. Because these people are probably looking for an apartment to rent. Also, we can say that the higher the demand, the higher the price. Therefore, we can explain the increase in rent amounts (showed in x axis) in the each histogram earlier. Last but not least, if we look box plots of _rents_ and _search volume of kiralik daire_, we can see that the rate of increase in rent is larger.
...
The third data consists the number of visitors resident in abroad who visit Turkey over 2012-2019, their average expenditure as dollars. But in this part, I took only the number of visitors column.
